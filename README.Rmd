...
Before proceeding with the examples you need to get a token / API key from the GIE homepage. Save the token to a file you name ".Renviron" and put it into your working directory. If you end up saving the file as .Renviron.txt or similar, you have made a mistake.
